...
//    for server: RPCServer, address: Address, with sessionConfig: Config, in
    static func make(messageHandler: WKScriptMessageHandler, address: String) -> WKWebViewConfiguration {
